...
public class AppView { 
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 540, 434);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);

		JLabel lbTitulo = new JLabel("Titulo:");
		lbTitulo.setBounds(55, 39, 42, 14);
		...
		lblParecer.setBounds(23, 134, 89, 14);
		...
		btnAdicionarParecer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(frame,"Data com formato inv�lido. Redigite.");
				} catch (IllegalArgumentException iae) {
					JOptionPane.showMessageDialog(frame,iae.getMessage());
				}
			}
		...
		lblConsultarUmTitulo.setBounds(133, 264, 126, 14);
